...
console.log('ctrl='+getURLParameter('ctrl'));
console.log('exp='+getURLParameter('exp'));
var ids=[];
if(controlOrExp=='experimental'){
	ids=getURLParameter('exp', window.parent.location);
}else{
	ids=getURLParameter('ctrl', window.parent.location);
}
